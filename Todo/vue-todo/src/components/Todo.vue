		    ...
		    <div class="content">
		        ...
		        <ul class="content_todoLists">
		            ...
		            v-show="defaultShow || (whichShow?list.isChecked:!list.isChecked)">
		                ...
		                @blur="unEdit(list)">
		                <span class="el-icon-close content_todoList_delete" :class="{show: list.isActive}" @click="deleteTodo(index)">x</span>
		            </li>
		        </ul>
		        ...
		        <div class="data" v-show="todoLists.length>0">
		            <div class="data_times" v-show="times === 0">
		                <span>{{times}}</span>&nbspitem <left></left>
		            </div>
		            <div class="data_times" v-show="times > 0">
...
export default {
  ...
  data() {
      return {
          todoLists: [],
          dataStatus: ["All", "Active", "Completed"],//切换任务状态
          dataStatusIndex: 0,
          whichShow: true,
          defaultShow: true
      }
